...
#default
  ...
  #description
  Written in GO and it has cover preview + many more.
  :: 
  ...
  Remote
  #description
  Highly Controllable Remotely Over the Network + Independently, Such as Play | Pause | Seek | Volume | Next | Previous | Loops ( Repeat | Infinity )
  ::
::
